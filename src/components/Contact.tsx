      ...
      <div className="grid sm:grid-cols-2 gap-4 max-w-2xl relative z-10">
        {CONTACT_LINKS.map((link) => (
          <a
            ...
            className="card p-6 flex flex-col gap-2 hover:border-white hover:-translate-y-1 hover:shadow-glow transition-all duration-300 group"
          >
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">{link.label}</span>
